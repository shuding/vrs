  ...
  <header className={`fixed w-100 ph3 pv3 pv3-ns ph3-m ph4-l fixed z-9999`}>
    ...
    <nav className="f6 fw6 ttu tracked dt-l w-100 mw8 center">
      ...
      <div className="w-100 w-90-l dtc-l tc tr-l v-mid">
        <Link href="/store">
          <a className={`link dim white dib mr3 v-mid ${Router.router && Router.router.pathname === '/store' && 'red'}`} title="Store">Store</a>
        </Link>
        <Link href="/about">
          <a className={`link dim white dib mr3 v-mid ${Router.router && Router.router.pathname === '/about' && 'red'}`} title="About">About</a>
        </Link>
        ...
        <Link href="/login">
          <a className={`link dim white dib v-mid ${Router.router && Router.router.pathname === '/login' && 'red'}`} title="Login">
